            ...
            <table cellpadding="0" cellspacing="0"  style="width: 100%;line-height: inherit;text-align: left;">
                <tr>
                    ...
                    <td colspan="2" style="padding:2px;font-size: 12px; border: 1px solid #000; text-align:center;">
                        <b style="font-size: 12px;"><?php echo getEduAppGTLang('full_name');?></b><br>
                ...
                <tr>
                    ...
                    <td style="padding:2px;font-size: 12px; border: 1px solid #000; text-align:center;">
                        ...
                        <?php echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?> - <?php echo $row['icourse'];?>
                    </td>
                    <?php /*
                        <td style="padding:2px;font-size: 12px; border: 1px solid #000; text-align:center;">
                    ...
                    */ ?>
                    <td style="padding:2px;font-size: 12px; border: 1px solid #000; text-align:center;">
                        <b style="font-size: 12px;"><?php echo getEduAppGTLang('2nd Language');?></b><br>
                        <?php echo $row['language'];?>
                    </td>                    
                </tr>
                <tr>
                    <td colspan="2" style="padding:2px;font-size: 12px; border: 1px solid #000; text-align:center;">
                        <b style="font-size: 12px;"><?php echo getEduAppGTLang('Hostel');?></b><br>
                        <?php echo $row['transport_id'];?>
                    </td>
                    <td colspan="2" style="padding:2px;font-size: 12px; border: 1px solid #000; text-align:center;">
                        <b style="font-size: 12px;"><?php echo getEduAppGTLang('Transportation');?></b><br>
                        <?php echo $row['hostel'];?>
                    </td>
                </tr>                
            </table>
